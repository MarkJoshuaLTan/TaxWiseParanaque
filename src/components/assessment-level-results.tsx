...
const ResultRow = ({
  ...
  if (isMain) {
    if (estimatedLength > 18) sizeClass = "text-base";
    else if (estimatedLength > 15) sizeClass = "text-lg";
    else if (estimatedLength > 12) sizeClass = "text-xl";
...
export function AssessmentLevelResults({
  ...
  const taxRate = results.taxRate || (isResidential ? 0.02 : 0.03);
              ...
              <CardHeader className="pb-4 pt-8">
                <div className="text-center">
                  <div className="text-5xl font-black text-primary mb-1 drop-shadow-[0_0_20px_rgba(34,197,94,0.4)]">
                    <span className="font-black text-5xl align-middle">{level * 100}</span>
                    <span className="font-black text-5xl align-middle">%</span>
                  </div>
